...
def createdb():
	c.execute("CREATE TABLE IF NOT EXISTS payments(accountno TEXT, Amount REAL, interest REAL , noOfDays INT, remainingdays INT, remainingamount INT, username TEXT, complete INT)")
